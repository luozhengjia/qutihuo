...
public class LoginController extends BaseController {
    ...
    public String index(HttpServletRequest request, ModelMap modelMap, Integer merchantId) throws Exception {

        // 从cookie中获取couponNumber
        modelMap.put("couponNumber", FrontUtil.getCookieValue(request, FrontUtil.COOKIE_COUPON_NUMBER));

        // 兼容黄龙县创业扶贫开发公司
        merchantId = merchantId != null ? merchantId : 4;
    ...
    @ResponseBody
    public String login(String couponNumber, String couponPassword, String validateCode, HttpServletRequest request, HttpServletResponse response) {
